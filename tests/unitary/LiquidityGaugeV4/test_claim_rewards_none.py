...
def test_claim_no_deposit(alice, bob, chain, gauge_v4, mock_lp_token, reward_contract, coin_reward):
    # Fund
...
def test_claim_no_rewards(alice, bob, chain, gauge_v4, mock_lp_token, reward_contract, coin_reward):
    # Deposit
