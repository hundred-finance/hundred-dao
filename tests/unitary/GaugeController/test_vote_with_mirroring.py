...
def gauge_vote_setup(accounts, chain, gauge_controller, three_gauges, voting_escrow, mirrored_voting_escrow, token):
...
def test_vote_partial(accounts, gauge_controller, three_gauges):
    ...
    assert gauge_controller.user_vote_power(accounts[0]) == 1234
